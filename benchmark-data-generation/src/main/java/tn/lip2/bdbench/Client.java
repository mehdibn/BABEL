...
/**
 * Main class for executing BDBench.
 */
public final class Client {
     ...
     * tn.lip2.bdbench.measurements.exporter.TextMeasurementsExporter.
     */
    public static final String EXPORTER_PROPERTY = "exporter";

    /**
     * If set to the path of a file, BDBench will write all output to this file
     * instead of STDOUT.
     */
    public static final String EXPORT_FILE_PROPERTY = "exportfile";

    /**
     * The number of BDBench client threads to run.
     */
    ...
    public static void usageMessage() {
        System.out.println("Usage: java tn.lip2.bdbench.Client [options]");
        ...
        //        "tn.lip2.bdbench.workloads.CoreWorkload)");
        System.out.println("");
    ...
    private static Tracer getTracer(Properties props, Workload workload) {
        return new Tracer.Builder("BDBench " + workload.getClass().getSimpleName())
    ...
    private static Workload getWorkload(Properties props) {
        ...
        try {
            ...
            System.err.println("BDBench Client " + projectProp.getProperty("version"));
        } catch (IOException e) {
