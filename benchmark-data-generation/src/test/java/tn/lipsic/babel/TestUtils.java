...
public class TestUtils {
    ...
    public void bytesToFromLong() throws Exception {
        ...
        assertEquals(tn.lipsic.babel.Utils.bytesToLong(bytes), 0L);
        assertArrayEquals(tn.lipsic.babel.Utils.longToBytes(0), bytes);

        bytes[7] = 1;
        assertEquals(tn.lipsic.babel.Utils.bytesToLong(bytes), 1L);
