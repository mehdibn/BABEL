...
import tn.lipsic.examples.lambda.listener.CustomStreamingListener;
...
public final class SparkStreamingAnalyzer extends GenericConsumer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // .set("spark.metrics.conf", "/Users/mehdi/IdeaProjects/babel/examples/src/main/resources/metrics.properties")
